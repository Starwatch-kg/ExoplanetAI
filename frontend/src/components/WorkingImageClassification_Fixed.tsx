  ...
  return (
    <div className="space-y-lg">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-lg">
        ...
        >
          {/* Выбор модели */}
          <div className="card hover-glow animate-shimmer">
            <div className="card-header">
          ...
          {/* Зона загрузки */}
          <div className="card surface-floating hover-lift-strong">
            <div className="card-header">
              <h3 className="card-title">
            ...
            <div className="card-body">
              <div
                className={`border-2 border-dashed rounded-lg p-8 text-center transition-all duration-300 ${
                  dragActive 
                    ? 'border-accent bg-accent/10 glow-medium' 
                    : 'border-secondary hover:border-accent hover:glow-subtle'
                }`}
                ...
                onDrop={handleDrop}
              >
                <Camera className="w-12 h-12 text-accent mx-auto mb-4 animate-float" />
                <p className="text-secondary mb-4">
                  Перетащите изображения сюда или
                </p>
                <button
                  onClick={() => fileInputRef.current?.click()}
                  className="btn btn-primary hover-lift-strong"
                >
                  Выберите файлы
                </button>
                <input
          ...
          {/* Примеры классов */}
          <div className="card glass-strong hover-glow breathe">
            <div className="card-header">
              <h3 className="card-title">
            ...
            <div className="card-body">
              <div className="space-y-sm">
                {exampleClasses.map((cls, index) => (
                  ...
                  >
                    <div className={`w-3 h-3 rounded-full bg-current ${cls.color} animate-pulse-glow`} />
                    <div>
                      <div className={`text-sm font-medium ${cls.color} text-glow`}>
                        {cls.name}
                      </div>
        ...
        >
          <div className="card cosmic-border hover-float">
            <div className="card-header">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-md">
                  {images.map((image, index) => (
                    <motion.div
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      transition={{ delay: index * 0.1 }}
                      className="surface-elevated hover-lift-strong animate-shimmer"
                    >
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <button
                          ...
                          className="btn btn-sm btn-secondary text-error hover:text-error hover:glow-subtle transition-all"
                        >
