    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 p-6">
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm border border-blue-500/30 rounded-lg p-6">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <div className={`text-lg font-bold ${systemStatus.color}`}>
      ...
      >
        {missionModules.map((module, index) => (
          <motion.div
            ...
            className="bg-gray-800/50 backdrop-blur-sm border border-blue-500/30 rounded-lg p-6 hover:border-blue-400/50 transition-all duration-300"
          >
      ...
      {systemMetrics && (
        <motion.div
          ...
          className="mt-8 bg-gray-800/50 backdrop-blur-sm border border-blue-500/30 rounded-lg p-6"
        >
