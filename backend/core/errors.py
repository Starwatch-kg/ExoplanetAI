...
def setup_error_handlers(app: FastAPI):
    ...
    async def handle_exoplanet_ai_exception(
        request: Request, exc: ExoplanetAIException
    ):
...
def create_error_response(
    error_code: str, detail: str, status_code: int = 400
) -> Dict[str, Any]:
    """Create a standard error response"""
    return {"error_code": error_code, "detail": detail, "status_code": status_code}
