...
def validate_array_size(data: List[Any], max_size: int = 100000, name: str = "array") -> List[Any]:
...
def validate_json_size(data: Dict[str, Any], max_size_mb: float = 10.0) -> Dict[str, Any]:
    ...
    if size_mb > max_size_mb:
        raise ValueError(f"JSON payload too large ({size_mb:.1f}MB, max {max_size_mb}MB)")
...
def validate_request_rate_limit(client_ip: str, endpoint: str, max_requests: int = 60) -> bool:
