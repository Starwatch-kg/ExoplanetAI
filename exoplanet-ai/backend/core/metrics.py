...
class MetricsCollector:
    ...
    def record_exoplanet_analysis(self, catalog: str, mission: str, status: str, 
                                  duration: float, candidates_found: int = 0, 
                                  max_snr: float = 0.0):
        ...
        with self.lock:
            ...
            self.analysis_stats['avg_processing_time'] = total_time / len(self.analysis_history)
    ...
    def record_ml_inference(self, model_name: str, duration: float, success: bool):
        ...
        with self.lock:
            ...
            if self.ml_metrics['total_inferences'] > 0:
                ...
                self.ml_metrics['avg_inference_time'] = (current_avg * (total - 1) + duration) / total
    
    def record_nasa_api_call(self, success: bool, duration: float, data_points: int = 0):
        ...
        with self.lock:
            ...
            self.nasa_api_metrics['avg_response_time'] = (current_avg * (total - 1) + duration) / total
